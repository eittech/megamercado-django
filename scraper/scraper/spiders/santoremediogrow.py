...
class ProductSpider(scrapy.Spider):
    name = "santoremediogrow"

    def start_requests(self):
        urls = [
            "https://santoremediogrow.cl/",
        ]
        for url in urls:
    ...
    def parse(self, response):
        ...
        for link_categoria in categorias:
            ...
            try:
                ...
                response.meta['shop'] = 'https://santoremediogrow.cl/'
                response.meta['shop_name'] = 'santoremediogrow.cl'
                yield response
            except:
                print("url no valida")
    ...
    def parse_category(self, response):
        list_product = response.css("ul.product_list div.product-image-container a.product_img_link")
        name_category = response.meta['name_category_safe']
        shop_url = response.meta['shop']
        shop_name = response.meta['shop_name']
