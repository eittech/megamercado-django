...
class ProductSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        categorias = response.css("nav#top-menu-nav ul#top-menu li")
        for link_categoria in categorias:
            ...
            if url_category is not None:
                ...
                response.meta['shop'] = 'https://mobydickgrow.cl/'
                response.meta['shop_name'] = 'mobydickgrow.cl'
                yield response
    ...
    def parse_category(self, response):
        ...
        list_product = response.css("div#content-area ul.products li a.woocommerce-LoopProduct-link")
    ...
    def parse_product(self,response):
        ...
        if category is not None:
            name_category = response.meta['name_category_safe']
            product = response.css("div#content-area")
