...
class ProductSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        categorias = response.css("ul#menu-menu-cannabisur-web-2016 li")
        for link_categoria in categorias:
            ...
            if url_category is not None:
                ...
                response.meta['shop'] = 'https://cannabisur.cl'
                response.meta['shop_name'] = 'cannabisur.cl'
                yield response
    ...
    def parse_category(self, response):
        ...
        list_product = response.css("div#content ul.products li a.woocommerce-LoopProduct-link")
