...
class ProductSpider(scrapy.Spider):
    ...
    def parse(self, response):
        categorias = response.css("div#block_top_menu ul li a")
        for link_categoria in categorias:
            ...
            try:
                ...
                response.meta['shop'] = 'http://www.eljardindejah.cl/'
                response.meta['shop_name'] = 'eljardindejah.cl'
                yield response
            except:
                print("url no valida")
