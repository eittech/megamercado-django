...
class ProductSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for link_categoria in categorias:
            ...
            if url_category is not None:
                ...
                response.meta['shop'] = 'https://www.growcenter.cl/'
                response.meta['shop_name'] = 'growcenter.cl'
                yield response
    ...
    def parse_category(self, response):
        ...
        list_product = response.css("div#primary ul.products li.product-type-simple a.woocommerce-LoopProduct-link")
        pagina_siguiente_css = response.css("nav.woocommerce-pagination ul.page-numbers li a.next")
    ...
    def parse_product(self,response):
        ...
        try:
            if name_category is None or name_category == "":
                spa = response.css("nav.woocommerce-breadcrumb a")
        ...
        if category is not None:
            ...
            if Product_object.id:
                list_img_t = product.css("div.images")
