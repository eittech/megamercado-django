...
class ProductSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        categorias = response.css("ul#widget-collapscat-2-top li")
        for link_categoria in categorias:
            ...
            if url_category is not None:
                ...
                response.meta['shop'] = 'http://www.meplanto.cl'
                response.meta['shop_name'] = 'meplanto.cl'
                yield response
    ...
    def parse_category(self, response):
        ...
        list_product = response.css("ul.products a.woocommerce-LoopProduct-link")
