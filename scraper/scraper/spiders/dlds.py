...
class ProductSpider(scrapy.Spider):
    ...
    def parse(self, response):
        categorias = response.css("nav#cbp-hrmenu li a")
        for link_categoria in categorias:
            ...
            try:
                ...
                response.meta['shop'] = 'https://dlds.cl/'
                response.meta['shop_name'] = 'dlds.cl'
                yield response
            except:
                print("url no valida")
    ...
    def parse_category(self, response):
        list_product = response.css("div#js-product-list div.thumbnail-container a.product-thumbnail")
    ...
    def parse_product(self,response):
        ...
        categ = response.xpath('.//nav[@class="breadcrumb"]/div/div/ol/li/a/span/text()').extract()
        print("####################################")
        print("####################################")
        print("####################################")
        print(categ)
        ...
        if category is not None:
            ...
            name = response.xpath('.//h1[@class="h1 page-title"]/span/text()').re_first('\w.*')
