...
class ProductSpider(scrapy.Spider):
    name = "elbotanicogrowshop"

    def start_requests(self):
        urls = [
            "https://www.elbotanicogrowshop.cl/",
        ]
        for url in urls:
    ...
    def parse(self, response):
        ...
        for link_categoria in categorias:
            ...
            try:
                ...
                response.meta['shop'] = 'https://www.elbotanicogrowshop.cl/'
                response.meta['shop_name'] = 'elbotanicogrowshop.cl'
                yield response
            except:
                print("url no valida")
    ...
    def parse_product(self,response):
        ...
        if category is not None:
            ...
            name = response.xpath('.//div[@class="summary entry-summary"]/h1[@class="product_title entry-title"]/text()').re_first('\w.*')
            ...
            try:
                ...
                for des in description1:
                    description = description + str(des) + str("<br>")
            except:
                print("error")
            category = category
            ...
            if Product_object.id:
                ...
                list_img = response.css('figure.woocommerce-product-gallery__wrapper a img')
