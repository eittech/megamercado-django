...
class ProductSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        categorias = response.css("div#quadmenu_1 ul.quadmenu-navbar-nav li")
        for link_categoria in categorias:
            ...
            if url_category is not None:
                try:
                    ...
                    response.meta['shop'] = 'https://www.growshopchile.cl/'
                    response.meta['shop_name'] = 'growshopchile.cl'
                    yield response
                except:
                    print("error en url")
    ...
    def parse_category(self, response):
        ...
        list_product = response.css("div.shop-products-inner div.product-type-simple a.woocommerce-LoopProduct-link")
    ...
    def parse_product(self,response):
        ...
        if True:
            ...
            name = response.xpath('.//div[@class="summary entry-summary single-product-info"]/h1[@class="product_title entry-title"]/text()').re_first('\w.*').rstrip()
        ...
        #             list_img = response.xpath('.//a[@class="yith_magnifier_zoom woocommerce-main-image"]')
        #             headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.3'}
        #             contador = 0
