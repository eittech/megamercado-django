...
class ProductSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        categorias = response.css("nav.fusion-main-menu ul#menu-main-menu li")
        for link_categoria in categorias:
            ...
            if url_category is not None:
                ...
                response.meta['shop'] = 'https://www.agua-luna.cl/2017/'
                response.meta['shop_name'] = 'agua-luna.cl'
                yield response
    ...
    def parse_category(self, response):
        ...
        list_product = response.css("div#content ul.products li a.product-images")
    ...
    def parse_product(self,response):
        ...
        if category is not None:
            ...
            name = product.xpath('.//div[@class="summary entry-summary"]/div[@class="summary-container"]/h2/text()').re_first('\w.*')
            ...
            try:
                description = ""
                description1 = response.css('div#tab-description div.post-content').extract_first()
