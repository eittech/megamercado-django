...
class ProductSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        categorias = response.css("ul#outer_ul li")
        for link_categoria in categorias:
            ...
            if url_category is not None:
                ...
                response.meta['shop'] = 'http://cultivados.cl/'
                response.meta['shop_name'] = 'cultivados.cl'
                yield response
    ...
    def parse_category(self, response):
        ...
        list_product = response.css("ul.products li a")
        pagina_siguiente_css = response.css("nav.woo-pagination a.next")
