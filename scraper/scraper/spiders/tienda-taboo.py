...
class ProductSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for link_categoria in categorias:
            ...
            if url_category is not None:
                ...
                response.meta['shop'] = 'https://tienda-taboo.cl/tienda/'
                response.meta['shop_name'] = 'tienda-taboo.cl'
                yield response
    ...
    def parse_product(self,response):
        ...
        if category is not None:
            ...
            name = product.xpath('.//div[@class="pb-center-column col-xs-12 col-sm-4"]/h1[@itemprop="name"]/text()').re_first('\w.*')
