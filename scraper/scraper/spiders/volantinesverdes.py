...
class ProductSpider(scrapy.Spider):
    name = "volantinesverdes"
    def start_requests(self):
        urls = [
            "https://volantinesverdes.cl/shop/",
        ]
        for url in urls:
    ...
    def parse(self, response):
        ...
        for link_categoria in categorias:
            ...
            if url_category is not None:
                ...
                response.meta['shop'] = 'https://volantinesverdes.cl/shop/'
                response.meta['shop_name'] = 'volantinesverdes.cl'
                yield response
    ...
    def parse_category(self, response):
        ...
        list_product = response.css("div.products div.product-grid-item a.product-image-link")
    ...
    def parse_product(self,response):
        ...
        if Product_object.id:
            headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.3'}
            list_img = response.css('figure.woocommerce-product-gallery__image a')
