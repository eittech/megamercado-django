...
urlpatterns = [
    ...
    path('cuenta/compras/preguntas/', compras_preguntas, name='compras_preguntas'),
    path('cuenta/compras/favoritos/', favoritos_list, name='favoritos_list'),
    path('cuenta/compras/favoritos/elim/<int:pk>/', favoritos_eliminar, name='favoritos_eliminar'),
    path('cuenta/compras/pedidos/', pedidos_compras, name='pedidos_compras'),
    path('cuenta/confirmar_recepcion/<int:pk>/', confirmar_recepcion, name='confirmar_recepcion'),
    ...
    path('cuenta/disputav/<int:pk>/', disputa_vendedor, name='disputa_vendedor'),
    path('cuenta/marcado_pagado/<int:pk>/', marcar_pagado, name='marcar_pagado'),
    path('cuenta/marcado_entregado/<int:pk>/', marcar_entregado, name='marcar_entregado'),
